...
describe('useFormBuilder', () => {
  it('should initialize with default values', () => {
    ...
    expect(result.current.state.raw).toEqual(expect.objectContaining({
      phone: '',
      ssn: '',
      country: '',
      state: '',
  ...
  it('should validate email format', async () => {
    ...
    expect(result.current.formState.errors.email?.message).toBe('Please enter a valid email address');
